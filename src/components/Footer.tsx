        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="text-center sm:text-left">
              <Image src="/logo-mobile.svg" alt="SpendWise" width={150} height={50} className="h-14 w-auto object-contain mb-2 mx-auto sm:mx-0" />
              <p className="text-xs text-neutral-500 mt-2 max-w-xs leading-relaxed mx-auto sm:mx-0">
                AI infrastructure spend optimization tool. Find discounts on AI and cloud credits from companies that overforecasted.
              </p>
              <a href="mailto:connect.with.karam25@gmail.com" className="text-xs text-neutral-400 mt-3 block">connect.with.karam25@gmail.com</a>
            </div>
            <div className="flex justify-center sm:justify-start gap-12">
              <div className="flex flex-col gap-2.5">
                ...
                <a href="#audit" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">Run Audit</a>
                <a href="#how-it-works" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">How it Works</a>
                <a href="#platforms" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">Platforms</a>
                <a href="#guarantee" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">Guarantee</a>
                <a href="#faq" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">FAQ</a>
              </div>
              <div className="flex flex-col gap-2.5">
                <span className="font-medium text-neutral-900 uppercase tracking-wider text-[11px] mb-1">Company</span>
                <a href="#" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">SpendWise</a>
                <a href="#" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">Buy Credits</a>
                <a href="#" className="text-xs text-neutral-500 hover:text-neutral-900 transition-colors py-0.5">Sell Credits</a>
              </div>
            </div>
            <div className="text-center sm:text-left">
          ...
          <div className="mt-8 pt-6 border-t border-neutral-100 flex flex-col items-center gap-3 sm:flex-row sm:justify-between sm:gap-2 text-[11px] text-neutral-400">
