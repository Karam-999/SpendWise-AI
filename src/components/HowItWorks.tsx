...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      desc: "Six deterministic rules check for plan downgrades, redundant tools, API inefficiencies, and enterprise overkill.",
    },
    {
      step: "03",
      title: "Get recommendations",
      desc: "Instant per-tool breakdown with savings amounts, an AI Spend Efficiency Score, and a shareable audit report.",
    },
  ];
  ...
  return (
    <section id="how-it-works" className="border-b border-neutral-200">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
        ...
        <h2 className="font-mono text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 mb-10">How the audit works</h2>
