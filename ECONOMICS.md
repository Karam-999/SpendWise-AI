...
- **Average order value (AOV):** $3,000 in credits per deal. Based on a startup buying 3–6 months of runway for one platform (e.g., $500/mo × 6 months of OpenAI API credits).
...
- **Revenue per converted lead:** $3,000 × 20% = **$600**.
...
| **End-to-end: Visitor → Purchase** | **0.18%** | 40% × 10% × 15% × 30% |
| **End-to-end: Audit → Purchase** | **0.45%** | 10% × 15% × 30% |
...
| Paid Twitter/X ads | ~$2 CPC × 2.5 clicks/audit | 222 | **$1,110** |
| Google Ads ("reduce AI costs") | ~$5 CPC × 3 clicks/audit | 222 | **$3,330** |

**Insight:** Organic channels dominate. Paid acquisition only makes sense after organic channels are saturated and the conversion funnel is validated. The Credex existing customer list is the most efficient channel by far — warm leads with 4× higher conversion.
...
1. **Viral loop works.** If 5% of audit completers share their URL, and each share generates 2 new visitors, that's a 0.1× viral coefficient. Not viral, but it compounds. With 500 daily organic audits, viral sharing adds ~50 more.
